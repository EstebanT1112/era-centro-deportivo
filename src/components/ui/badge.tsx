  ...
  "group/badge inline-flex min-h-6 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-colors duration-150 focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&>svg]:pointer-events-none [&>svg]:size-3.5!",
  {
    variants: {
      variant: {
        ...
        danger: "bg-destructive/10 text-destructive ring-1 ring-destructive/18",
        info: "bg-info/10 text-info ring-1 ring-info/18",
        neutral: "bg-neutral/10 text-neutral ring-1 ring-neutral/18",
      },
    },
    defaultVariants: {
      variant: "default",
